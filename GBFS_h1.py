...
## THIS CODE IS FOR SCALING ANALYSIS

# file = open("sample2x4.txt", "r")
...
#     fileName = "2x4/" + str(puzzleNumber) + "_gbfs-h1_2x4_solution.txt"
#     f = open(fileName, "w")
#     log = []
#     costTotal = 0
#     cost = 0
...
# for puzzleNumber in range(0, len(puzzleList)):
#     node, closedList, exactTime = gbfs_h1(puzzleList[puzzleNumber])
#     fileName = "2x4/" + str(puzzleNumber) + "_gbfs-h1_2x4_search.txt"
#     f = open(fileName, "w")
